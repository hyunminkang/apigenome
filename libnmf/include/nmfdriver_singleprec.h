#ifndef UNIVIE_NMFLIB_NMFDRIVER_SINGLEPREC_H
#define UNIVIE_NMFLIB_NMFDRIVER_SINGLEPREC_H
...
int nmfDriver_singleprec(const char* a, int k, int iter, const char* w0, const char* h0, alg_t alg, options_t * opts);
