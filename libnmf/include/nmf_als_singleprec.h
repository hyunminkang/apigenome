#ifndef UNIVIE_NMFLIB_NMF_ALS_SINGLEPREC_H
#define UNIVIE_NMFLIB_NMF_ALS_SINGLEPREC_H
...
float nmf_als_singleprec(float ** a, float ** w0, float ** h0, int m, int n,int k, int * maxiter, const float TolX, const float TolFun);
