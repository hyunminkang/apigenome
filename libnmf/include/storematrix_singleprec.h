#ifndef UNIVIE_NMFLIB_STOREMATRIX_SINGLEPREC_H
#define UNIVIE_NMFLIB_STOREMATRIX_SINGLEPREC_H
...
void storeMatrix_singleprec(const char *fileName, const int m, const int n, const float *matrix);
