#ifndef UNIVIE_NMFLIB_GETENTROPY_H
#define UNIVIE_NMFLIB_GETENTROPY_H
...
double getEntropy( double * classColumn, int m, int isClass, double * classvalueCount, int numDistClasses);
