#ifndef UNIVIE_NMFLIB_CHECKARGUMENTS_SINGLEPREC_H
#define UNIVIE_NMFLIB_CHECKARGUMENTS_SINGLEPREC_H
...
int checkArguments_singleprec(const char* a, const int k, int iter, const char* w0, const char* h0, options_t_singleprec * opts);
