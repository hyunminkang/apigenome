#ifndef UNIVIE_NMFLIB_SETDEFAULTOPTS_SINGLEPREC_H
#define UNIVIE_NMFLIB_SETDEFAULTOPTS_SINGLEPREC_H
...
void set_default_opts_singleprec(options_t_singleprec * opts);
