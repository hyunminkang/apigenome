#ifndef UNIVIE_NMFLIB_CHECKMATRICES_SINGLEPREC_H
#define UNIVIE_NMFLIB_CHECKMATRICES_SINGLEPREC_H
...
int checkMatrices_singleprec(const float * a, const float * w, const float * h, const int m, \
