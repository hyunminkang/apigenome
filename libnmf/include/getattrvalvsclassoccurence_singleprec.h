#ifndef UNIVIE_NMFLIB_GETATTRVALVSCLASSOCCURENCE_SINGLEPREC_H
#define UNIVIE_NMFLIB_GETATTRVALVSCLASSOCCURENCE_SINGLEPREC_H
...
void getattrValVsClassOccurence_singleprec(float  * attrCol, int m, float  * classCol, int numDistClasses, float  * classvalueCount, float  * uniqueAttrVals, int * numUniqueAttrVals, int * classCountForAttrIndex);
