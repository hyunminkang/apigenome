#ifndef UNIVIE_NMFLIB_LOADMATRIX_SINGLEPREC_H
#define UNIVIE_NMFLIB_LOADMATRIX_SINGLEPREC_H
...
void loadMatrix_singleprec(const char *fileName, int *m, int *n, float **matrix);
