#ifndef UNIVIE_NMFLIB_NMF_BAYES_SINGLEPREC_H
#define UNIVIE_NMFLIB_NMF_BAYES_SINGLEPREC_H


/**
 * NMF_BAYES -	calculates the nmf using a normal equation alternating least squares method
 *
 * Purpose:
